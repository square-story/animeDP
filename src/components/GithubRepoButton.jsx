...
const GithubRepoButton = () => {
    ...
    const repoOwner = "square-story";
    const repoName = "animeDP";
            ...
            >
                ...
                <div className="ml-2 flex items-center gap-1 text-sm md:flex">
                    ...
                    >
                        <path
                            clipRule="evenodd"
                            d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.256-5.273-4.116-3.527c-.888-.76-.416-2.212.748-2.305l5.405-.434 2.082-5.006z"
                            fillRule="evenodd"
                        ></path>
                    </svg>
                    {starCount !== null && (
